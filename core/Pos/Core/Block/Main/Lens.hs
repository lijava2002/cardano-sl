...
mbTxs :: Lens' (Body (MainBlockchain v)) ([Tx])
mbTxs = mbTxPayload . txpTxs

-- | Lens for witness list in main block body.
mbWitnesses :: Lens' (Body (MainBlockchain v)) [TxWitness]
